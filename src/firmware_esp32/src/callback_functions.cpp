...
//     micro_custom_messages__msg__JointTrajectoryReducedArray * msg = 
//         (micro_custom_messages__msg__JointTrajectoryReducedArray *) msgin;

//     int array_size = msg->array_size;
//     msg->set_points.capacity = array_size;
//     msg->set_points.data = (micro_custom_messages__msg__JointTrajectoryReduced *) malloc(
//         array_size * sizeof(micro_custom_messages__msg__JointTrajectoryReduced));
//     msg->set_points.size = 0;
//     // float * joint_trajectory = malloc(array_size*sizeof(micro_custom_messages__msg__JointTrajectoryReduced));
