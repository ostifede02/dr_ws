...
def main():
    ...
    ax1.plot(path_vector[:,0], path_vector[:,1], path_vector[:,2], marker="o", color='blue')
    ax1.set_xlabel('X')
    ax1.set_ylabel('Y')
    ax1.set_zlabel('Z')
    ...
    ax2.plot(trajectory_vector[:,0], trajectory_vector[:,1], trajectory_vector[:,2], marker="o", color='orange')
    ax2.set_xlabel('X')
    ax2.set_ylabel('Y')
    ax2.set_zlabel('Z')
