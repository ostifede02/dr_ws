...
bool deltarobot_interfaces__msg__set_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("deltarobot_interfaces.msg._set_point.SetPoint", full_classname_dest, 45) == 0);
  }
  deltarobot_interfaces__msg__SetPoint * ros_message = _ros_message;
  {  // x
  ...
  {  // delta_t
    ...
    assert(PyFloat_Check(field));
    ros_message->delta_t = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * deltarobot_interfaces__msg__set_point__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("deltarobot_interfaces.msg._set_point");
