...
#include "deltarobot_interfaces/msg/detail/set_point__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deltarobot_interfaces::msg::SetPoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const deltarobot_interfaces::msg::SetPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<deltarobot_interfaces::msg::SetPoint *>(
    untyped_ros_message);
...
{
  return &deltarobot_interfaces::msg::typesupport_fastrtps_cpp::_SetPoint__handle;
}
