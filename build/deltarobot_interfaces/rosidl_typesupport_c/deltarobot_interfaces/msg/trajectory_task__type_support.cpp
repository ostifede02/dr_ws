...
static const _TrajectoryTask_type_support_symbol_names_t _TrajectoryTask_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deltarobot_interfaces, msg, TrajectoryTask)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, deltarobot_interfaces, msg, TrajectoryTask)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, deltarobot_interfaces, msg, TrajectoryTask)() {
  return &::deltarobot_interfaces::msg::rosidl_typesupport_c::TrajectoryTask_message_type_support_handle;
}
