...
#include "deltarobot_interfaces/msg/detail/trajectory_task__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/point32__functions.h"  // pos_end, pos_start
#include "std_msgs/msg/detail/string__functions.h"  // task_type

// forward declare type support functions
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_deltarobot_interfaces
...
using _TrajectoryTask__ros_msg_type = deltarobot_interfaces__msg__TrajectoryTask;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _TrajectoryTask__ros_msg_type * ros_message = static_cast<const _TrajectoryTask__ros_msg_type *>(untyped_ros_message);
  // Field name: pos_start
  {
  ...
  void * untyped_ros_message)
{
  ...
  _TrajectoryTask__ros_msg_type * ros_message = static_cast<_TrajectoryTask__ros_msg_type *>(untyped_ros_message);
  // Field name: pos_start
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_deltarobot_interfaces__msg__TrajectoryTask(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TrajectoryTask__ros_msg_type * ros_message = static_cast<const _TrajectoryTask__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _TrajectoryTask__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_deltarobot_interfaces__msg__TrajectoryTask(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_deltarobot_interfaces
size_t max_serialized_size_deltarobot_interfaces__msg__TrajectoryTask(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = deltarobot_interfaces__msg__TrajectoryTask;
    is_plain =
      (
...
static size_t _TrajectoryTask__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_deltarobot_interfaces__msg__TrajectoryTask(
...
static message_type_support_callbacks_t __callbacks_TrajectoryTask = {
...
static rosidl_message_type_support_t _TrajectoryTask__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_TrajectoryTask,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, deltarobot_interfaces, msg, TrajectoryTask)() {
  return &_TrajectoryTask__type_support;
}
