...
static const _SetPointsVector_type_support_symbol_names_t _SetPointsVector_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, deltarobot_interfaces, msg, SetPointsVector)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, deltarobot_interfaces, msg, SetPointsVector)),
  }
};
...
{
  return &::deltarobot_interfaces::msg::rosidl_typesupport_cpp::SetPointsVector_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, deltarobot_interfaces, msg, SetPointsVector)() {
  return get_message_type_support_handle<deltarobot_interfaces::msg::SetPointsVector>();
}
